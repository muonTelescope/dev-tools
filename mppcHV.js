...
module.exports = class mppcHV {
    ...
    // sudo node -e 'new (require("./mppcHV"))(0x08).setTarget(0,55.25);'                
    ...
    // sudo node -e 'new (require("./mppcHV"))(0x08).readVoltage(0);'            
    readVoltage(channel) {
        var CHANNEL_ADDR;
        switch (channel) {
            case 0:
    ...
    // Command line single use example
    // sudo node -e 'new (require("./mppcHV"))(0x08).readTarget(0);'        
    readTarget(channel) {
        var CHANNEL_ADDR;
        switch (channel) {
            case 0:
    ...
    // Command line single use example
    // sudo node -e 'new (require("./mppcHV"))(0x08).readTemp(0);'    
    readTemp(channel) {
        var CHANNEL_ADDR;
        switch (channel) {
            case 0:
    ...
    //
    // sudo node -e 'new (require("./mppcHV"))(0x08).voltageDump();'
    //
